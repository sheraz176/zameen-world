...
<head>
    ...
    <title>Zameen world || Sign Up</title>
  ...
  <section>
    <div class="newpass-wrapper">
      <div class="d-flex flex-column gap-2 px-3">
        <h3 class="popup-heading text-center mt-5 mb-3">Sign Up</h3>
      </div>
          ...
          <div class="row custom-inputs">
            <div class="col-md col-md-12">
              ...
              <div class="input-group mb-3">
                  ...
                  <input id="password" type="password" class="form-control border-end-0 {{ $errors->has('password') ? 'is-invalid' : '' }}" name="password" required placeholder="Password"
              ...
              <div class="input-group mb-3">
                  ...
                  <input id="password-confirm" class="form-control border-end-0"  type="password" placeholder="Confirm Password" name="password_confirmation" required aria-label="Recipient's username" aria-describedby="basic-addon2">
              ...
              <div class="d-flex flex-row gap-2 sign-up-checkbox align-items-center">
                <input type="checkbox">
                <label class="no-account"> I accept Zameen World <b>Terms of use and Privacy Policy</b></label>
              </div>
            </div>
            <div class="col-md-12 mt-4 mb-3">
              <div class="mb-3">
                <div class="d-flex flex-column gap-3">
                  <button type="submit" class="btn-contain-normal w-100 mt-4" >Sign
                    Up</button>
                  <span class="d-block text-center no-account mt-3">Already have an account? <a href="{{ route('login') }}">Log
                      In</a></span>
                </div>
              </div>
            </div>
