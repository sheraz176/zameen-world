        ...
        <div class="custom-container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-8">
                    ...
                    <div class="ba2c32de">
    <div class="">
        <div class="_23b128fb d-flex flex-row gap-2 flex-wrap" aria-label="Nav bar">
            <a class="_147317c5 active" href="#overviewSection">Overview</a>
            <a class="_147317c5 " href="#locationSection">Location &amp; Nearby</a>
           
            <a class="_147317c5 " href="#indexSection">Price Index</a>
...
<ul class="properties-cards">
    ...
    <li class="prop-card-child super-hot">
        ...
        <div class="card-body-custom">
            ...
            <div class="d-flex flex-column gap-1 my-3">
                <p class="prop-price-text"><span>PKR</span> {{ $property->price }}</p>
    ...
    <li class="prop-card-child featured">
        <div class="image-wrapper position-relative">
            <figure class="m-0">
            <img src=" {{ asset('zameen/assets/images/blog-detail.png') }}" alt="" srcset="">
    ...
    <li class="prop-card-child normal">
        <div class="image-wrapper position-relative">
            <figure class="m-0">
            <img src=" {{ asset('zameen/assets/images/video-img.png') }}" alt="" srcset="">
            </figure>
        ...
        <div id="propcardslider" class="carousel slide pointer-event" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <div class="image-wrapper position-relative">
                        <figure class="m-0">
                        <img src=" {{ asset('zameen/assets/images/proper-sm.png') }}" alt="" srcset="">
                                alt="" srcset="">
                        </figure>
                        <div class="top-data d-flex flex-row justify-content-between align-items-center">
                            <label class="super-hot-label">super hot</label>
                ...
                <div class="carousel-item active">
                    <div class="image-wrapper position-relative">
                        <figure class="m-0">
                        <img src=" {{ asset('zameen/assets/images/technology.png') }}" alt="" srcset="">
                                alt="" srcset="">
                        </figure>
                        <div class="top-data d-flex flex-row justify-content-between align-items-center">
                            <label class="super-hot-label">super hot</label>
