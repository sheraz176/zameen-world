<ul class="properties-cards active">
            ...
            <li class="prop-card-child super-hot">
              <div id="propcardsliderhot" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                  <div class="carousel-item active">
                  <div class="image-wrapper position-relative">
    <figure class="m-0">
        <a href="<?php echo route('property.show', [$property->slug, $property->random_id]); ?>">
        ...
        @elseif(!empty($property->location_latitude))
              ...
              <div class="card-body-custom">
                ...
                <div class="d-flex flex-column gap-1 my-3">
                  <p class="prop-price-text"><span>PKR</span> {{ formatPrice($property->price) }}</p>
...
<div class="col-md-4">
    <div class="single-cards-slider buy-page-card">
        <a href="{{ route('property.show', [$property->slug, $property->random_id]) }}">
