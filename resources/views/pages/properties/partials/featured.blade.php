            ...
            <div class="card-body-custom">
                ...
                <div class="d-flex flex-row gap-1 align-items-center">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="16"
                    ...
                    <defs>
                      ...
                      <linearGradient id="e" x1="124.5" x2="134.5" y1="137" y2="137" gradientUnits="userSpaceOnUse"
              ...
              <div class="d-flex flex-row gap-2">
                ...
                <div class="d-flex flex-row gap-1 align-items-center">
                  ...
                  <span class="font-weight-500">{{ $property->area }} {{ $property->unit }}</span>
                </div>
              </div>
              <div class="mt-2">
                ...
                <div class="detail-text flex-row align-items-center">
                  <div class="cf36e19e">
                    <span class="b779b320">{{ ucfirst($property->address) }}</span>
                  </div>
